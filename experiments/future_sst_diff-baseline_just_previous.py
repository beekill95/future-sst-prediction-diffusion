...
#     language: python
#     name: python3
#   title: Future SST Difference Prediction using Just one Previous Diff As Baseline
#     Diffusion
# ---
...
# # Future SST Difference Prediction using Just one Previous Diff As Baseline
#
# In this experiment,
# I will construct a baseline to compare with diffusion model
# by using the previous difference as the prediction for the future difference.
#
# In this,
...
for (X_diff, y_diff), (X, y) in zip(test_diff_dataloader, test_dataloader):
    # Predict the future difference by using only the previous difference.
    y_pred_diff = X_diff[:, -1:]
